...
/*   Updated: 2022/11/07 17:26:38 by nosterme         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
	...
	std::map< unsigned int, int >	map2( map1 );
	...
	std::map< unsigned int, int >	map4( ++( map1.begin() ), --( map1.end() ) );
